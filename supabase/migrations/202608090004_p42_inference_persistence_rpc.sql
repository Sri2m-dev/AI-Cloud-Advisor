...
revoke all on function public.p42_save_inferred_classification(uuid,jsonb) from public,anon;
grant execute on function public.p42_save_inferred_classification(uuid,jsonb)
