...
def reports_page():
    ...
    with board_tab:
        ...
        if st.button("Prepare Board Pack PPTX", key="prepare_board_pack_pptx", width="stretch"):
            from cloud_report_generator import generate_boardroom_pptx
            _prepare_report(
                "report_board_pack_pptx",
                lambda: generate_boardroom_pptx(
                    client_name,
                    monthly_spend=summary_metrics["total_monthly_cost"],
                    savings_monthly=summary_metrics["potential_savings"],
                    top_service_name=top_service,
...
with st.sidebar:
    ...
    st.caption("Enterprise Cloud Governance & FinOps Platform")
    current_plan = get_user_plan(st.session_state.get("username", "guest"))
...
if selected_page == "Dashboard":
    ...
    from Dev.pages.cloud_accounts import cloud_accounts_page
    cloud_accounts_page()
    ...
    st.markdown("""
## 1. Introduction
We value your privacy and are committed to protecting your personal and business data. This Privacy Policy explains how AI Cloud Advisor ("we", "our", "us") collects, processes, and protects your data in compliance with the General Data Protection Regulation (GDPR).
