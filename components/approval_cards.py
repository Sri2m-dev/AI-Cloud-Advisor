"""
Reusable approval card components for Streamlit dashboards.
"""
import streamlit as st

def approval_card(title, status, approver, submitted_at, on_approve=None, on_reject=None, user_role=None):
    """
