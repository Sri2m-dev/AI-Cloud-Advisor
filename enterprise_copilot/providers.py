        ...
        response = self.client.post(
            ...
            json={
                ...
                "instructions": (
                    ...
                    "Each capability descriptor declares its supported parameters. "
                    "For each selected capability, populate only parameters explicitly "
                    "declared by that capability. The fixed response schema always includes "
                    "query, result_limit, filter, and value parameter slots; set every slot "
                    "not declared by the selected capability to null. Represent measures, "
                    "dimensions, filters, and grouping only in their dedicated plan-level "
                    "fields; do not duplicate them into capability parameters unless that "
                    "parameter is explicitly declared by the selected capability. "
                    "For a SUMMARY operation, do not add dimensions, filters, or grouping "
                    "merely to restate the subject or domain already represented by the "
                    "selected capability; use dimensional constraints only when the requested "
                    "conclusion requires them and the selected operation can execute them. "
