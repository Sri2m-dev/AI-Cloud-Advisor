...
returns setof data_fabric.ontology_concepts language sql security definer set search_path = data_fabric, pg_temp as $$
...
returns setof data_fabric.ontology_relationships language sql security definer set search_path = data_fabric, pg_temp as $$
...
$$;
revoke all on function data_fabric.data_fabric_update_ontology_concept(text, text, text, integer, jsonb) from public;
grant execute on function data_fabric.data_fabric_update_ontology_concept(text, text, text, integer, jsonb) to service_role;
revoke all on function data_fabric.data_fabric_update_ontology_relationship(uuid, text, text, integer, jsonb) from public;
grant execute on function data_fabric.data_fabric_update_ontology_relationship(uuid, text, text, integer, jsonb) to service_role;
