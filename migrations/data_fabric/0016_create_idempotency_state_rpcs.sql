...
returns setof data_fabric.idempotency_records language plpgsql security definer as $$
...
returns setof data_fabric.idempotency_records language sql security definer as $$
